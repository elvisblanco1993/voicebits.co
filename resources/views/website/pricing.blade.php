    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-0 text-slate-800">
        <div class="py-20">
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12 md:col-span-4 bg-violet-100 px-6 py-8 rounded-lg">
                    ...
                    <p class="mt-6">
                        <a href="{{ route('register') }}" class="inline-block w-full px-4 py-2 text-white bg-violet-600 hover:bg-violet-700 text-center font-medium rounded-full">Get started with a free trial</a>
                    </p>
                </div>
            </div>
