<div class="block max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-slate-800 dark:text-white">
    <div class="grid grid-cols-2 gap-8">
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="" class="inline-block mt-4 text-indigo-500">Tell me more -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="" class="inline-block mt-4 text-indigo-500">How to distribute my podcast -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="" class="inline-block mt-4 text-indigo-500">Show me a podcast's website -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="" class="inline-block mt-4 text-indigo-500">Try the embedded player -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="" class="inline-block mt-4 text-indigo-500">Learn more about analytics -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="" class="inline-block mt-4 text-indigo-500">Get support -></a>
        </div>
    </div>
</div>
