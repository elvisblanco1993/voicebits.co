<div class="block max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-slate-800 dark:text-white">
    <div class="grid grid-cols-2 gap-8">
        ...
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="https://voicebits.co/blog?search=distribution" class="inline-block mt-4 text-[#0099ff]">More in our blog -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="https://voicebits.co/blog?search=websites" class="inline-block mt-4 text-[#0099ff]">More in our blog -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="https://voicebits.co/blog?search=player" class="inline-block mt-4 text-[#0099ff]">More in our blog -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="https://voicebits.co/blog?search=analytics" class="inline-block mt-4 text-[#0099ff]">More in our blog -></a>
        </div>
        <div class="col-span-2 md:col-span-1 p-8 rounded-xl shadow bg-white dark:bg-gray-800 text-center md:text-left">
            ...
            <a href="https://voicebits.co/blog?search=support" class="inline-block mt-4 text-[#0099ff]">More in our blog -></a>
        </div>
    </div>
</div>
