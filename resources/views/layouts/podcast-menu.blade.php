<div class="w-full h-64 bg-gradient-to-tr from-slate-300 to-slate-200 text-slate-900 rounded-2xl">
    <div class="w-full h-full flex items-center justify-between space-x-6 px-4 sm:px-6 lg:px-8">
        <div class="">
...
<div class="mt-4 flex items-center justify-between overflow-auto py-2 ">
