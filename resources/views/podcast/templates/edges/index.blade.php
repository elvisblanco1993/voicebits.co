...
@section('content')
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="my-6 grid grid-cols-6 gap-8">
            <div class="col-span-6 md:col-span-4">
                ...
                <div class="mt-4">
                    <a wire:navigate class="text-sm font-semibold  underline capitalize text-slate-800 inline-flex items-center space-x-3"
