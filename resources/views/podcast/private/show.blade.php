        ...
        <div class="mt-6 px-4 py-8 bg-white shadow rounded-lg">
            ...
            <div class="mt-6 max-w-xs mx-auto">
                <div class="sm:hidden">
                    ...
                    <a href="overcast://x-callback-url/add?url={{ route('private.podcast.feed', ['url' => $subscriber->token]) }}" class="mt-4 relative block group px-4 py-3 rounded-md font-medium bg-[#FC7E0F]/10 text-[#FC7E0F] hover:bg-[#FC7E0F] hover:text-white transition-all">
                ...
                <button id="feed-to-clipboard" onclick="copyToClipboard('{{route('private.podcast.feed', ['url' => $subscriber->token])}}')"
