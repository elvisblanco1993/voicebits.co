    ...
    <div class="max-w-3xl mx-auto py-12 lg:py-24 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-6 px-4 py-8 bg-white shadow rounded-lg">
            ...
            <div class="mt-6 max-w-xs mx-auto">
                <div class="sm:hidden">
                    <a href="itpc://https://{{ $deepFeedUrl }}" class="mt-4 relative block px-4 py-3 rounded-md font-medium bg-[#FB5BC5]/10 text-[#FB5BC5] hover:bg-[#FB5BC5] hover:text-white transition-all group">
                    ...
                    <a href="podcast://https://{{ $deepFeedUrl }}" class="mt-4 relative block group px-4 py-3 rounded-md font-medium bg-[#9933CC]/10 text-[#9933CC] hover:bg-[#9933CC] hover:text-white transition-all">
                    ...
                    <a href="pktc://https://{{ $deepFeedUrl }}" class="mt-4 relative block group px-4 py-3 rounded-md font-medium bg-[#F43E37]/10 text-[#F43E37] hover:bg-[#F43E37] hover:text-white transition-all">
                    ...
                    <a href="podcastaddict://https://{{ $deepFeedUrl }}" class="mt-4 relative block group px-4 py-3 rounded-md font-medium bg-[#F4842D]/10 text-[#F4842D] hover:bg-[#F4842D] hover:text-white transition-all">
                    ...
                    <a href="overcast://x-callback-url/add?url=https://{{$deepFeedUrl}}" class="mt-4 relative block group px-4 py-3 rounded-md font-medium bg-[#FC7E0F]/10 text-[#FC7E0F] hover:bg-[#FC7E0F] hover:text-white transition-all">
