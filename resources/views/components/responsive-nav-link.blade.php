...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-amber-400 text-base font-medium text-amber-700 bg-amber-50 focus:outline-none focus:text-amber-800 focus:bg-amber-100 focus:border-amber-700 transition'
