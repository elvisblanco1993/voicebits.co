        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('shows') }}">
                        ...
                        <img src="{{ asset('logo-mark.svg') }}" alt="{{ config('app.name') }}" class="block h-9 w-auto">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @if (!Auth::user()->currentTeam->subscribed('voicebits'))
                    @if (Carbon\Carbon::now() > Auth::user()->currentTeam->trial_ends_at)
                        <div class="px-3 py-1 bg-red-100 border border-red-300 rounded-lg text-sm text-red-800 flex items-center">
                            <span>Your trial ended on {{ date("m/d/Y", strtotime(Auth::user()->currentTeam->trial_ends_at)) }}</span>
                        ...
                        <x-jet-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-lg">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-lg text-gray-500 bg-white hover:bg-gray-50 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition">
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-lg">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-lg text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                        {{ Auth::user()->name }}
