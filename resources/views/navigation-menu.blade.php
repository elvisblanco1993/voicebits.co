<div>
    <div class="w-full bg-white text-slate-900 text-sm border-b border-b-slate-100">
        <div class="max-w-5xl mx-auto h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            {{-- Desktop right --}}
            <div class="flex items-center space-x-4">
                <a href="https://voicebits.tawk.help"
                    title="Documentation and Support"
                    target="_voicebitshelp"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-slate-600 hover:text-black transition-all">
