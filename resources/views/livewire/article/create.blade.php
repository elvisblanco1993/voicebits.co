<div>
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-0">
        ...
        <div class="mt-4">
            <div class="w-full bg-white p-8 rounded-lg grid grid-cols-4 gap-4">
                <div class="col-span-4 md:col-span-1 mx-auto">
                    ...
                    @else
                        <div class="w-36 h-36 text-sm text-center rounded-lg flex items-center justify-center bg-indigo-100 text-indigo-400 p-4">
        ...
        <div class="mt-6 flex items-end justify-between">
            ...
            <div class="">
                <x-jet-button wire:click="save">Save Post</x-jet-button>
            </div>
        </div>
    </div>
</div>
