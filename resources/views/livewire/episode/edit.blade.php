    ...
    <div class="mt-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div class="text-2xl font-bold">Episode details</div>
            </div>
        ...
        <div class="mt-4 w-full bg-white rounded-lg shadow p-8">
            <div class="">
                <div class="h-16 px-4 rounded-lg border-dashed border border-gray-400 bg-white flex items-center justify-between">
                    ...
                    <label for="track" class="text-sm text-slate-600 px-3 py-2 rounded-lg border border-slate-200 hover:text-purple-600 hover:bg-purple-50 hover:border-purple-200 transition-all cursor-pointer">
        ...
        <div class="mt-4 w-full bg-white rounded-lg shadow p-8">
            <div class="">
                <div class="flex items-center justify-between">
                    ...
                    <button class="flex items-center space-x-2 text-sm text-slate-600 hover:text-purple-600 transition-all" onclick="copyEmbed()">
