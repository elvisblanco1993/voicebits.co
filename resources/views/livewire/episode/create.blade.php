        ...
        <div class="mt-4 w-full bg-white rounded-lg shadow">
            <div class="p-6">
                ...
                <div>
                    ...
                    <x-input-error for="track" class="mb-2 text-sm text-red-600"/>
                ...
                <div class="mt-6 grid grid-cols-6 gap-8 items-center">
                    <div class="col-span-2 md:col-span-1">
                        ...
                        @else
                            <div class="flex-none w-full h-full aspect-square rounded-lg bg-indigo-50 border border-indigo-100 text-indigo-300 flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
