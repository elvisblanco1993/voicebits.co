    ...
    <div class="mt-4 max-w-5xl mx-auto px-4 sm:px-6 lg:px-0">
        <div class="flex items-center justify-between">
            ...
            <x-button wire:click="save">
                <span wire:loading.remove="save">Upload Episode</span>
                <svg wire:loading="save" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 animate-spin">
