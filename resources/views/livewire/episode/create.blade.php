<div>
    ...
    <div class="py-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-0">
        ...
        <div class="mt-4 grid grid-cols-6 gap-4">
            {{-- Main content --}}
            <div class="col-span-6 md:col-span-4 p-4 border border-slate-200 bg-white rounded-lg">
                <div>
                        ...
                        <div class="absolute">
                            <div class="flex items-center gap-2">
                                ...
                                @else
                                    ...
                                    <span class="block font-normal text-sm">Upload episode audio<p class="text-xs text-gray-500">MP3 only supported</p></span>
                                @endif
                            </div>
                        </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea wire:model.live="description" id="description" rows="12" class="input"></textarea>
