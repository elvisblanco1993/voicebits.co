    ...
    <div class="max-w-3xl mx-auto py-12 lg:py-24 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mt-6 px-4 py-8 bg-white shadow rounded-lg">
            ...
            @elseif($status === 'failed')
                <div class="flex items-center justify-center w-16 h-16 mx-auto rounded-full aspect-square bg-rose-200">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-rose-700">
