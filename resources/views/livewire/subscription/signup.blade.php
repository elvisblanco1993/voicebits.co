<div>
    <div class="py-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-0">
        ...
        <div class="my-6 w-12 border-t border-violet-300"></div>
        <div class="my-6">
            ...
            <div class="mt-4 grid grid-cols-12 gap-8">
                <div class="col-span-12 md:col-span-8 space-y-2">
                    <button wire:click="save(1)" class="md:flex w-full items-center justify-between border border-slate-300 hover:border-violet-500 p-6 rounded-lg group">
                        ...
                        <div class="uppercase text-4xl font-black text-slate-400 group-hover:text-violet-500">Starter</div>
                    </button>
                    <button wire:click="save(2)" class="md:flex w-full items-center justify-between border border-slate-300 hover:border-violet-500 p-6 rounded-lg group">
                        <div class="md:flex items-center space-y-2 md:space-y-0 md:space-x-8">
                            <p class="text-3xl font-extrabold">$35<span class="font-light">/</span>m</p>
                            <p>65,000 downloads per month</p>
                        </div>
                        <div class="uppercase text-4xl font-black text-slate-400 group-hover:text-violet-500">Business</div>
                    </button>
                    <button wire:click="save(3)" class="md:flex w-full items-center justify-between border border-slate-300 hover:border-violet-500 p-6 rounded-lg group">
                        <div class="md:flex items-center space-y-2 md:space-y-0 md:space-x-8">
                            <p class="text-3xl font-extrabold">$65<span class="font-light">/</span>m</p>
                            <p>180,000 downloads per month</p>
                        </div>
                        <div class="uppercase text-4xl font-black text-slate-400 group-hover:text-violet-500">Agency</div>
                    </button>
                </div>
        ...
        {{-- <div class="grid grid-cols-2 gap-8">
            ...
            {{-- <div class="col-span-2 sm:col-span-1">
                <button wire:click="save(1)" class="w-full text-left">
                    <div class="w-full rounded-lg border border-slate-300 border-l-4 p-4 hover:border-violet-400 transition-all">
