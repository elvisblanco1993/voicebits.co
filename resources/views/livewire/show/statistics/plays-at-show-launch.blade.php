    ...
    <div class="w-full p-8 bg-white rounded-lg shadow">
        ...
        <div class="grid grid-cols-2 gap-4 py-6">
            <div class="col-span-2 sm:col-span-1">
                <p class="font-normal text-xl text-blue-600 text-center">{{ $thirty_days ?? 0 }}</p>
                <p class="text-sm font-normal text-slate-500 text-center">First 30 days</p>
            </div>
            <div class="col-span-2 sm:col-span-1">
                <p class="font-normal text-xl text-blue-600 text-center">{{ $sixty_days ?? 0 }}</p>
                <p class="text-sm font-normal text-slate-500 text-center">First 60 days</p>
            </div>
            <div class="col-span-2 sm:col-span-1">
                <p class="font-normal text-xl text-blue-600 text-center">{{ $ninety_days ?? 0 }}</p>
                <p class="text-sm font-normal text-slate-500 text-center">First 90 days</p>
            </div>
            <div class="col-span-2 sm:col-span-1">
                <p class="font-normal text-xl text-blue-600 text-center">{{ $hundred_twenty_days ?? 0 }}</p>
