        ...
        <div class="mt-4 w-full bg-white rounded-lg shadow p-8">
            <div class="">
                ...
                <div class="mt-2 flex items-center justify-between">
                    ...
                    <button class="w-auto text-center text-slate-600 px-4 py-2 rounded-l-none rounded-lg border border-slate-200 hover:text-indigo-600 hover:bg-blue-50 hover:border-blue-200 transition-all"
                    id="rssBtn"
