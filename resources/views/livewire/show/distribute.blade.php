    ...
    <div class="py-6">
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Radio Public, use <a href="https://radiopublic.com//" target="_dario_public" class="underline">their portal</a>.</p>
                <x-input type="url" wire:model.live="deezer" class="mt-2 w-full" placeholder="https://radiopublic.com/my-podcast"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
