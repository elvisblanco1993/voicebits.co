<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
        ...
        <div class="mt-4 w-full bg-white rounded-lg shadow p-8">
            ...
            <p>Here you can add all the places where you are distributing your show. If you need help distributing your podcast, <a href="#" class="underline text-indigo-600">follow this guide</a>.</p>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'apple-podcasts']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'spotify']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'google-podcasts']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'stitcher']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'pocket-casts']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'amazon-music']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'pandora']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'iheartradio']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'castbox']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'deezer']) }}</span>
            </div>
            <div class="mt-8">
                ...
                <span class="text-sm text-indigo-600">{{ route('show.feed', ['url' => $podcast->url, 'player' => 'castro']) }}</span>
            </div>
        </div>
    </div>
    <script>
