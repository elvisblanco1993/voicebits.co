<div>
    @livewire('submenu')
    <div class="py-6">
        <div class="mt-2 text-slate-600">Distribute your podcast to any of the platforms listed below. Not sure where to start? Check out <a href="#" class="underline">this article</a> for more information.</div>
        <div class="mt-4 w-full bg-white rounded-lg shadow p-8">
            <div>
                <div class="text-sm text-slate-700 font-medium flex items-center space-x-2">
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Spotify, use <a href="https://podcasters.spotify.com/" target="_spotify" class="underline">their portal</a>.</p>
                <x-input type="url" wire:model.live="spotify" class="mt-2 w-full" placeholder="https://open.spotify.com/show...."/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'spotify']) }}</p>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Apple Podcasts, use <a href="https://podcasters.spotify.com/" target="_spotify" class="underline"> Apple Podcasts Connect</a>.</p>
                <x-input type="url" wire:model.live="apple" class="mt-2 w-full" placeholder="https://itunes.apple.com/my-podcast"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'apple-podcasts']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Pocket Casts, use <a href="https://www.pocketcasts.com/" target="_pocket_casts" class="underline">their portal</a>.</p>
                <x-input type="url" wire:model.live="pocketcasts" class="mt-2 w-full" placeholder="https://pca.st/my-podcast"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'pocketcasts']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Amazon Music, use <a href="https://podcasters.amazon.com/" target="_amazon_music" class="underline">their portal</a>.</p>
                <x-input type="url" wire:model.live="amazon" class="mt-2 w-full" placeholder="https://music.amazon.com/podcasts/my-podcast"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'amazon-music']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Pandora, use <a href="https://www.ampplaybook.com/podcasts" target="_pandora" class="underline">their portal</a>.</p>
                <x-input type="url" wire:model.live="pandora" class="mt-2 w-full" placeholder="https://pandora.com/podcasts/your-podcast"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'pandora']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to iHeartRadio, use <a href="https://podcasters.iheart.com/" target="_iheartradio" class="underline">their portal</a>.</p>
                <x-input type="url" wire:model.live="iheartradio" class="mt-2 w-full" placeholder="https://www.iheart.com/podcast/my-podcast"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'iheartradio']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Castbox, use <a href="https://castbox.fm/podcasters-tools/" target="_castbox" class="underline">Castbox Creator Studio</a>.</p>
                <x-input type="url" wire:model.live="castbox" class="mt-2 w-full" placeholder="https://castbox.fm/my-podcast"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'castbox']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Podcast Addict, use <a href="https://podcastaddict.com/submit" target="_podcast_addict" class="underline">their form</a>.</p>
                <x-input type="url" wire:model.live="podcastaddict" class="mt-2 w-full" placeholder="https://podcastaddict.com/podcast/your-podcast/123456"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'podcastaddict']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Deezer, use <a href="https://podcasters.deezer.com/" target="_deezer" class="underline">their portal</a>.</p>
                <x-input type="url" wire:model.live="deezer" class="mt-2 w-full" placeholder="https://deezer.com/show/1234567890"/>
            </div>
            <div class="px-8 py-4 bg-slate-100 flex justify-end sm:justify-between items-center rounded-b-lg">
                <p class="hidden sm:block text-xs font-mono text-slate-600">{{ route('public.podcast.feed', ['url' => $podcast->url, 'player' => 'deezer']) }}</p>
                <x-button wire:click="save">{{ __("Save changes") }}</x-button>
            </div>
        </div>
