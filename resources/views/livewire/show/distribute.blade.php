    ...
    <div class="py-6">
        ...
        <div class="w-full bg-white rounded-lg shadow">
            <div class="p-8">
                ...
                <p class="mt-2 text-sm font-medium text-slate-600">To submit to Radio Public, use <a href="https://radiopublic.com//" target="_radiopublic" class="underline">their portal</a>.</p>
