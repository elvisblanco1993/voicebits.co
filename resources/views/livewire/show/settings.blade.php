        ...
        <div id="artwork" class="w-full bg-white rounded-lg shadow">
            ...
            <div class="px-8 py-4 bg-slate-100 flex justify-between rounded-b-lg">
                <div class="flex items-center justify-center gap-4">
                    ...
                    <div>
                        <label for="artwork-file" class="text-sm text-slate-600 px-3 py-2 rounded-lg border border-slate-200 hover:text-blue-600 hover:bg-blue-50 hover:border-blue-200 transition-all cursor-pointer">
