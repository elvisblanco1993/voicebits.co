    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
        ...
        <div class="mt-4 w-full bg-white rounded-lg shadow p-8">
            ...
            <div class="mt-6" id="show-url">
                ...
                <a href="https://{{str($podcast->name)->slug()}}.voicebits.co" target="_blank" class="mt-1 text-xs font-medium tracking-wider text-blue-600">https://{{ ($url) ? str($url)->slug() : str($podcast->name)->slug() }}.voicebits.co</a>
            </div>
        </div>
        ...
        <div class="mt-4 w-full bg-white rounded-lg shadow p-8">
            <div class="grid grid-cols-4 gap-8">
                <div class="col-span-4 sm:col-span-1">
                    ...
                    @else
                        <div class="w-full aspect-square bg-blue-100 flex items-center justify-center rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-blue-500" fill="currentColor" class="bi bi-soundwave" viewBox="0 0 16 16">
