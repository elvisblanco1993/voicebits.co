        ...
        <form wire:submit.prevent="save">
            ...
            <div class="mt-6 grid grid-cols-2 gap-8">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <label for="serial" class="mt-1 inline-flex items-center space-x-3 text-sm px-4 py-2 border rounded-lg cursor-pointer hover:border-teal-300">
                        <input type="radio" name="type" wire:model="type" id="serial" value="serial" class="cursor-pointer">
                        <span>{{ __("Serial") }}</span>
                    </label>
                    <label for="episodic" class="mt-1 mx-2 inline-flex items-center space-x-3 text-sm px-4 py-2 border rounded-lg cursor-pointer hover:border-teal-300">
            ...
            <div class="mt-6 flex justify-end">
                <a href="{{ route('podcast.catalog') }}"
                    class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-teal-300 focus:ring focus:ring-teal-200 active:text-gray-800 active:bg-gray-50 disabled:opacity-25 transition"
                >{{ __("Cancel") }}</a>
