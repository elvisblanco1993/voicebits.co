<div>
    <button wire:click="$toggle('modal')" title="Edit user" class="text-slate-600 hover:text-violet-600 flex items-center">
                    ...
                    @forelse ($podcast_permissions as $permission => $val)
                        <div class="col-span-1">
                            <label for="{{$val}}" class="mt-2 flex items-center">
                                <x-input type="checkbox" name="permissions" wire:model.defer="permissions" id="{{$val}}" value="{{$val}}" />
