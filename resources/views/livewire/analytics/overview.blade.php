    ...
    <div x-data="{
        ...
        >
            <div class="text-slate-600 flex items-center space-x-2 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-indigo-300">
                ...
                <p class="text-sm text-slate-600">Overall downloads</p>
            </div>
            <div x-ref="chart"></div>
    </div>
</div>
