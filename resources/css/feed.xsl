...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:content="http://purl.org/rss/1.0/modules/content">
    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="content">
                    <p class="explanation">
                        This is a podcast RSS created by <a href="https://voicebits.co" target="_blank">Voicebits</a>. It is meant for consumption by podcast feed readers using the URL in the address bar.
                    </p>
