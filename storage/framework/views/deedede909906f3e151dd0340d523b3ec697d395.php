    ...
    <div class="w-full bg-slate-900 text-white text-sm">
        <div class="max-w-5xl mx-auto h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
            <div class="flex items-center space-x-6">
                <a href="<?php echo e(route('shows')); ?>" class="inline-block">
                    <img src="<?php echo e(asset('logo-mark.svg')); ?>" alt="<?php echo e(config('app.name')); ?>" class="block h-8 w-auto">
                </a>

                <a href="<?php echo e(route('shows')); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php $component->withAttributes([]); ?>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_billing')): ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => ''.e(route('billing')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('billing')).'']); ?>
...
<?php /**PATH /home/elvis/Projects/voicebits-2.0/resources/views/navigation-menu.blade.php ENDPATH**/ ?>