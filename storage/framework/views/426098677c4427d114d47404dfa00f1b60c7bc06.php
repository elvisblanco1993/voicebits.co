<div>
    <div class="w-full p-8 bg-white rounded-lg shadow text-right">
        ...
        <div class="text-center gap-2 py-8">
            <p class="font-normal text-xl text-blue-600"><?php echo e($average_size ?? 0); ?></p>
            <p class="text-sm font-normal text-slate-500">Subscribers</p>
        </div>
    </div>

</div>
<?php /**PATH /home/elvis/Projects/voicebits-2.0/resources/views/livewire/show/statistics/estimated-audience-size.blade.php ENDPATH**/ ?>