    ...
    <div class="w-full p-8 bg-white rounded-lg shadow">
        ...
        <div class="grid grid-cols-2 gap-2 py-8">
            <div class="col-span-2 sm:col-span-1">
                <p class="font-normal text-xl text-blue-600 text-center"><?php echo e($from_third_parties); ?></p>
                <p class="text-sm font-normal text-slate-500 text-center">Podcatchers</p>
            </div>
            <div class="col-span-2 sm:col-span-1">
                <p class="font-normal text-xl text-blue-600 text-center"><?php echo e($from_website); ?></p>
                <p class="text-sm font-normal text-slate-500 text-center">RSS/Website</p>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/elvis/Projects/voicebits-2.0/resources/views/livewire/show/statistics/total-plays.blade.php ENDPATH**/ ?>