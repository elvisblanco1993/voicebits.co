<div class="bg-white dark:bg-gray-800 py-12 md:py-36">
    <div class="block max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-black dark:text-white">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <a href="" class="inline-block mt-6 px-5 py-2.5 text-sm font-semibold bg-[#0099ff] hover:bg-[#0099ff]/90 rounded-lg transition-all">Learn More</a>
            </div>
        </div>
        <div class="py-12"></div>
        <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <a href="" class="inline-block mt-6 px-5 py-2.5 text-sm font-semibold text-white bg-[#0099ff] hover:bg-[#0099ff]/90 rounded-lg transition-all">Learn More</a>
            </div>
        </div>
        <div class="py-12"></div>
        <div class="grid md:grid-cols-2 gap-12 items-center">
...
<?php /**PATH /home/elvis/Projects/voicebits-2.0/resources/views/web/website/partials/features.blade.php ENDPATH**/ ?>